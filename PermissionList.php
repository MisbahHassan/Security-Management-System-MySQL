...
<table cellpadding="8">
  <tr>
	...
	<?php $query="Select * from permissions";
	...
	if($noOfRecords>0)
	{
		...
		echo "<td><button type='submit' name='edit' value='$permission_id'> Edit </button></td>";
		echo "<td><button type='submit' name='delete' value='$permission_id'> DELETE </button></td>";
		echo "</tr>";
		}
	}
	?>
...
<br><br>
<form>
<input type='submit' name='newUser' value = 'Create New Permission'>
</form>
</body>
</html>
